        ...
        <div className="row row-cols-1 row-cols-md-3 g-4">
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
            <div className="card h-100 position-relative shadow d-flex flex-column">
                <div className="position-relative">
                    <img src="events/lon-2024-poster.webp" className="card-img-top" alt="Log Off Night 2024 image" />
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
            <div className="card h-100 position-relative shadow-sm d-flex flex-column">
                <div className="position-relative">
                    <img src="events/pixel-2024-poster.webp" className="card-img-top" alt="PIXEL 2024 image" />
                    <div className="position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center w-100 h-100">
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
            <div className="card h-100 position-relative shadow-sm d-flex flex-column">
                <div className="position-relative">
                    <img src="events/agm-2024-poster.webp" className="card-img-top" alt="Annual General Meeting 2024 image" />
                    <div className="position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center w-100 h-100">
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
            <div className="card h-100 position-relative shadow-sm d-flex flex-column">
                <div className="position-relative">
                    <img src="events/vhack-2024-poster.webp" className="card-img-top vhack-img" alt="Varsity Hackathon 2024 image" />
                    <div className="position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center w-100 h-100">
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
            <div className="card h-100 position-relative shadow-sm d-flex flex-column">
                <div className="position-relative">
                    <img src="events/sukapps-2024-poster.webp" className="card-img-top" alt="Sukan Antara Pusat Pengajian Sains 2024 image" />
                    <div className="position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center w-100 h-100">
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
            <div className="card h-100 position-relative shadow-sm d-flex flex-column">
                <div className="position-relative">
                    <img src="events/frostynight-2023-poster.webp" className="card-img-top" alt="Frosty Fantasy Night 2023 image" />
                    <div className="position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center w-100 h-100">
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
            <div className="card h-100 position-relative shadow-sm d-flex flex-column">
                <div className="position-relative">
                    <img src="events/me2-2024-poster.webp" className="card-img-top" alt="Major Minor Exploration Event 2024 image" />
                    <div className="position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center w-100 h-100">
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
            <div className="card h-100 position-relative shadow-sm d-flex flex-column">
                <div className="position-relative">
                    <img src="events/vcsirf-2023-poster.webp" className="card-img-top" alt="Virtual Computer Science Internship &#38; Recruitment Fair 2023 image"/>
                    <div className="position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center w-100 h-100">
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
            <div className="card h-100 position-relative shadow-sm d-flex flex-column">
                <div className="position-relative">
                    <img src="events/csbersamamu-2023-poster.webp" className="card-img-top" alt="CS Bersamamu 2023 image" />
                    <div className="position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center w-100 h-100">
